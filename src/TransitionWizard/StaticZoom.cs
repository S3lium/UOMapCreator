...
namespace TransitionWizard
{
    public partial class StaticZoom : Form
    {
        ...
        {
            System.Drawing.Font font = new("Arial", 8f);
            ...
            do
            {
                ...
                do
                {
                    ...
                    if (Art.GetStatic(value) != null)
                    {
                        ...
                        Rectangle rectangle = new(checked(checked(num1 * 50) + 2), checked(checked(num * 60) + 12), 44, 44);
                        Rectangle rectangle1 = new(1, 1, 44, 44);
