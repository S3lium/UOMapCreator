...
namespace CreateTransitions
{
    public class PrintTransition
    {
        ...
        private readonly XmlDocument iXml;
        ...
        private void PrDoc_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            this.yPos = marginBounds.Top;
            marginBounds = e.MarginBounds;
            this.xPos = marginBounds.Left;
            ...
            do
            {
                ...
                point1 = new Point(checked((int)Math.Round(xPos)), checked((int)Math.Round((double)((float)(this.yPos + 2f)))));
            ...
            while (!(single > checked(marginBounds.Bottom - 140) | this.iElement.NextSibling == null));
            if (this.iElement.NextSibling != null)
            {
                e.HasMorePages = true;
            }
