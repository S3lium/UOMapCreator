...
namespace CreateTransitions
{
    public partial class StaticZoom : Form
    {
        ...
        private void Panel2_Paint(object sender, PaintEventArgs e)
        {
            ...
            do
            {
                ...
                do
                {
                    ...
                    {
                        graphics.DrawString(index.ToString(), font, solidBrush, checked(num2 * 50 + 1), checked(num1 * 60 + 1));
                        Rectangle destRect = new(checked(num2 * 50 + 2), checked(num1 * 60 + 12), 44, 44);
                        Rectangle srcRect = new(1, 1, 44, 44);
                        graphics.DrawImage(Art.GetStatic(index), destRect, srcRect, GraphicsUnit.Pixel);
                        checked { ++index; }
                    }
                    checked { ++num2; }
                }
        ...
        private void Panel2_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            LateBinding.LateSetComplex(this.Tag, null, "Value", new object[1]
            {
                 iSelected
            }, (string[])null, 0 != 0, 1 != 0);
