...
namespace CreateStatics
{
    public partial class CreateStatics : Form
    {
        ...
        public CreateStatics()
        {
            ...
            do
            {
                ...
                do
                {
                    ...
                    Point point = new(checked(num - checked(num3 * 22)), checked(num1 + checked(num3 * 22)));
        ...
        private void Panel3_Paint(object sender, PaintEventArgs e)
        {
            ...
            try
            {
                ...
                while (enumerator.MoveNext())
                {
                    ...
                    Point point = new(checked((int)Math.Round(StaticGrid[y, x].X - (double)@static.Width / 2)), checked(checked(this.StaticGrid[y, x].Y - @static.Height) + 22));
        ...
        private void UpdatePanel()
        {
            ...
            Point point = new(checked(this.HScrollBar1.Value * -1), checked(this.VScrollBar2.Value * -1));
