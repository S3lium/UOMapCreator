...
namespace Ultima
{
    ...
    {
        private static FileIndex m_FileIndex = new("Texidx.mul", "Texmaps.mul", 0x4000, 10);
        ...
        public static unsafe Bitmap GetTexture(int index, out bool patched)
        {
            ...
            Bitmap bmp = new(size, size, PixelFormat.Format16bppArgb1555);
        ...
        public static unsafe void Save(string path)
        {
            ...
            for (int index = 0; index < GetIdxLength(); ++index)
            {
                ...
                else
                {
                    ...
                    bmp.UnlockBits(bd);
                    CheckSums s = new() { pos = start, length = length, checksum = checksum, index = index };
