    ...
    public sealed class MultiMap
    {
        ...
        public static unsafe Bitmap GetMultiMap()
        {
            ...
            if (path != null)
            {
                ...
                Bitmap multimap = new(width, height, PixelFormat.Format16bppArgb1555);
        ...
        public static unsafe Bitmap GetFacetImage(int id)
        {
            ...
            if (path != null)
            {
                using (BinaryReader reader = new(new FileStream(path, FileMode.Open, FileAccess.Read, FileShare.Read)))
                {
        ...
        public static unsafe void SaveFacetImage(string path, Bitmap sourceBitmap)
        {
            ...
            using BinaryWriter writer = new(new FileStream(path, FileMode.Create, FileAccess.ReadWrite, FileShare.ReadWrite));
