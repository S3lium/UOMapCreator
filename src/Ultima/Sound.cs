...
namespace Ultima
{
    ...
    public static class Sounds
    {
        ...
        public static void Initialize()
        {
            ...
            Regex reg = new(@"(\d{1,3}) \x7B(\d{1,3})\x7D (\d{1,3})", RegexOptions.Compiled);
        ...
        public static UOSound GetSound(int soundID, out bool translated)
        {
            ...
            UOSound sound = new(str, soundID, resultBuffer);
        ...
        {
            using FileStream wav = new(file, FileMode.Open, FileAccess.Read, FileShare.Read);
        ...
        public static void Save(string path)
        {
            ...
            for (int i = 0; i < m_Cache.Length; ++i)
            {
                ...
                else
                {
                    ...
                    binmul.Write(b);
                    using (MemoryStream m = new(sound.buffer))
                    {
