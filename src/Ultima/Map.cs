...
namespace Ultima
{
    public sealed class Map
    {
        ...
        public static Map Felucca = new(0, 0, 6144, 4096);
        ...
        {
            Bitmap bmp = new(width << 3, height << 3, PixelFormat.Format16bppRgb555);
        ...
        public static void DefragStatics(string path, Map map, int width, int height, bool remove)
        {
            ...
            {
                MemoryStream memidx = new();
                MemoryStream memmul = new();
        ...
        public void ReportInvisStatics(string reportfile)
        {
            ...
            using StreamWriter Tex = new(new FileStream(reportfile, FileMode.Create, FileAccess.ReadWrite), System.Text.Encoding.GetEncoding(1252));
