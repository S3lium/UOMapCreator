...
namespace CreateFacet
{
    public partial class CreateFacet : Form
    {
        ...
        private void Make()
        {
            ...
            ClsElevationTable clsAltitudeTable = new();
            ...
            if (Directory.Exists(baseDirectory))
            {
                ...
                ClsTerrainTable clsTerrainTable = new();
                        ...
                        try
                        {
                            ...
                            else
                            {
                                ...
                                if (mapTile == null)
                                {
                                    ...
                                    mapCell[m, n].ChangeAltID(clsTerrain.AltID);
                                    clsTerrain = null;
                                }
                                else
                                {
                ...
                this.iLogger.StartTask();
                ImportTiles importTile = new(collections, this.ProjectPath.Text);
                //this.iLogger.EndTask();
                this.iLogger.LogTimeStamp();
                this.iLogger.LogMessage("\r\n");
                ...
                FileStream fileStream1 = new(str, FileMode.Create);
                this.iLogger.LogMessage(str);
                str = string.Format("{0}/Statics{1}.mul", this.ProjectPath.Text, num);
                FileStream fileStream2 = new(str, FileMode.Create);
                this.iLogger.LogMessage(str);
                BinaryWriter binaryWriter1 = new(fileStream1);
                BinaryWriter binaryWriter2 = new(fileStream2);
                int num22 = num8;
